...
#define FTM2_PRECISON 100u     //（舵机）定义占空比精度，100即精度为1%，1000u则精度为0.1%，用于占空比 duty 形参传入，即占空比为 duty/FTM_PRECISON
...
extern void  FTM_port_mux(FTMn_e ftmn, FTM_CHn_e ch);                  //初始化FTM 的端口
